...
namespace Restaurant.Persistence.Migrations
{
    ...
    [Migration("20240223142944_AddPayDateTimeToOrder")]
    partial class AddPayDateTimeToOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Restaurant.Domain.Entities.BranchWorkingHours", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Restaurant.Domain.Entities.Identity.RoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Restaurant.Domain.Entities.Identity.UserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Restaurant.Domain.Entities.Identity.UserLogin", b =>
                {
            ...
            modelBuilder.Entity("Restaurant.Domain.Entities.Identity.UserRole", b =>
                {
                    b.Property<long>("UserId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Restaurant.Domain.Entities.Identity.UserToken", b =>
                {
                    b.Property<long>("UserId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Restaurant.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<int>("TableRentalMinutePrice")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Restaurant.Domain.Entities.Branch", b =>
                {
                    b.HasOne("Restaurant.Domain.Entities.Identity.User", "Admin")
                        .WithMany("Branches")
            ...
            modelBuilder.Entity("Restaurant.Domain.Entities.Category", b =>
                {
                    b.HasOne("Restaurant.Domain.Entities.Image", "Image")
                        .WithOne("Category")
                        .HasForeignKey("Restaurant.Domain.Entities.Category", "ImageId");
            ...
            modelBuilder.Entity("Restaurant.Domain.Entities.Identity.User", b =>
                {
                    b.HasOne("Restaurant.Domain.Entities.Image", "Avatar")
                        .WithOne("User")
                        .HasForeignKey("Restaurant.Domain.Entities.Identity.User", "AvatarId");
